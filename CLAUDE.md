...
| Sales (quotations, orders, invoices, receipts, returns) | Sales Quotation (with Prospect support) and Sales Order (Direct + Against-Quotation, price/discount governance, Payment Terms master) done. Invoices/Receipts/Returns pending |
