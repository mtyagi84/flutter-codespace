-- ============================================================
-- fn_get_user_menu
-- Returns sidebar menu for a logged-in user.
-- Groups features by module. Respects both master (client-level)
-- and user-level is_active / view_allowed gates.
