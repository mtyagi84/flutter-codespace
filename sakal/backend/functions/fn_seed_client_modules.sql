...
begin
    ...
    values
        ...
        (p_client_id, p_company_id, v_sl, 'SL-INR', 'Pending Approvals', '/sales/pending-approvals', 3, 'SL-TXN', 'Transactions', 1, true, false, false),
        (p_client_id, p_company_id, v_sl, 'SL-RET', 'Sales Return',    '/sales/returns',    4, 'SL-TXN', 'Transactions', 1, true,  false, false),
        (p_client_id, p_company_id, v_sl, 'SL-DEL', 'Sales Delivery',  '/sales/deliveries', 5, 'SL-TXN', 'Transactions', 1, true,  false, false),
        (p_client_id, p_company_id, v_sl, 'SL-RCP', 'Cash Receipt',    '/sales/receipts',   6, 'SL-TXN', 'Transactions', 1, false, false, false)
    on conflict (client_id, company_id, feature_code) do update
        set group_code      = excluded.group_code,
            group_name      = excluded.group_name,
            group_serial_no = excluded.group_serial_no;
