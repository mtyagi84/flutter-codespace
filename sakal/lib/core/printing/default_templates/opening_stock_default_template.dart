...
const openingStockDefaultTemplate = PrintTemplate(
  ...
  elements: [
    ...
    // Title/Opening No/Date as a right-aligned block beside the logo/company
    ...
    PrintElement(
      ...
      lines: [
        PrintElement(id: 'title', type: PrintElementType.text, text: 'Opening Stock',
            font: PrintFont(size: 16, bold: true, align: PrintAlign.right, colorHex: '#1B3A6B')),
        PrintElement(id: 'opening_no', type: PrintElementType.field, bind: 'header.opening_no', label: 'Opening No: ',
            font: PrintFont(size: 10, bold: true, align: PrintAlign.right)),
        PrintElement(id: 'opening_date', type: PrintElementType.field, bind: 'header.opening_date', label: 'Date: ',
