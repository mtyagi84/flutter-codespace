...
const purchaseOrderDefaultTemplate = PrintTemplate(
  ...
  elements: [
    ...
    // Title/PO No/Date as a right-aligned block beside the logo/company
    ...
    PrintElement(
      ...
      lines: [
        PrintElement(id: 'title', type: PrintElementType.text, text: 'Purchase Order',
            font: PrintFont(size: 16, bold: true, align: PrintAlign.right, colorHex: '#1B3A6B')),
        PrintElement(id: 'po_no', type: PrintElementType.field, bind: 'header.order_no', label: 'PO No: ',
            font: PrintFont(size: 10, bold: true, align: PrintAlign.right)),
        PrintElement(id: 'po_date', type: PrintElementType.field, bind: 'header.order_date', label: 'Date: ',
