...
/// ric_print_templates row for document_type='PURCHASE_RETURN'. Field
/// bindings match the document map built by PurchaseReturnEntryScreen's
/// Print handler — see that screen's `_buildPrintDocument()`. Same
/// row-grouping/flex-weight model as grn_default_template.dart.
const purchaseReturnDefaultTemplate = PrintTemplate(
  ...
  elements: [
    ...
    PrintElement(
      ...
      lines: [
        PrintElement(id: 'title', type: PrintElementType.text, text: 'Purchase Return',
    ...
    PrintElement(
      ...
      columns: [
        ...
        PrintTableColumn(bind: 'source_grn_no', label: 'GRN No', width: 40),
        PrintTableColumn(bind: 'return_qty', label: 'Qty', width: 20, align: PrintAlign.right, format: PrintDataFormat.number),
