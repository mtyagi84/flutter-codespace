...
const salesOrderDefaultTemplate = PrintTemplate(
  ...
  elements: [
    ...
    // Title/Order No/Date as a right-aligned block beside the logo/company
    ...
    PrintElement(
      ...
      lines: [
        PrintElement(id: 'title', type: PrintElementType.text, text: 'Sales Order',
            font: PrintFont(size: 16, bold: true, align: PrintAlign.right, colorHex: '#1B3A6B')),
        PrintElement(id: 'order_no', type: PrintElementType.field, bind: 'header.order_no', label: 'Order No: ',
            font: PrintFont(size: 10, bold: true, align: PrintAlign.right)),
        PrintElement(id: 'order_date', type: PrintElementType.field, bind: 'header.order_date', label: 'Date: ',
    ...
    PrintElement(id: 'div_totals', type: PrintElementType.line, x: 1, y: 15.5, w: 180, h: 0.5),
    ...
    PrintElement(id: 'sig_line_1', type: PrintElementType.line, x: 1, y: 21.6, w: 80, h: 0.5),
    PrintElement(id: 'sig_line_2', type: PrintElementType.line, x: 2, y: 21.6, w: 80, h: 0.5),
    PrintElement(
