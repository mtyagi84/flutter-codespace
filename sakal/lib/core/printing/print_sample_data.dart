...
class PrintSampleData {
  ...
  static Map<String, dynamic> forDocumentType(String documentType) => switch (documentType) {
    ...
    'SALES_RETURN' => {
      ...
      'lines': [
        {'product_name': 'Sample Item A', 'return_qty': 2, 'rate': 30.0, 'final_amount': 60.0},
      ],
      'totals': {
        'taxable_amount': 51.72,
        'tax_amount': 8.28,
        'return_total': 60.0,
      },
    },
    'SALES_DELIVERY' => {
      'company': _company(),
      'header': {
        'delivery_no':            'SDEL/KIN/2026/00001',
        'delivery_date':          '20 Jul 2026',
        'status':                 'APPROVED',
        'invoice_no':             'SI/KIN/2026/00001',
        'invoice_date':           '18 Jul 2026',
        'customer_name':          'Walk-in Customer',
        'location_name':          'Kinshasa Main',
        'ship_to_location_name':  'Main Warehouse - Kinshasa',
        'ship_to_address_line1':  '123 Boulevard du 30 Juin',
        'ship_to_address_line2':  'Gombe',
        'ship_to_contact_person': 'Jean Mbala',
        'ship_to_contact_phone':  '+243 000 000 000',
        'received_by_name':       'John Doe',
        'vehicle_no':             'KN 1234 AB',
        'transporter_name':       'Sample Transporters Ltd',
        'driver_name':            'Pierre Kalala',
        'driver_phone':           '+243 111 111 111',
        'reason':                 '',
        'remarks':                'Sample remarks for preview.',
        'signatures': {'prepared_by': 'Sample User', 'authorised_by': 'Sample Approver'},
      },
      'lines': [
        {'product_name': 'Sample Item A', 'barcode': '8901234567890', 'uom_name': 'PCS', 'qty_pack': 2, 'qty_loose': 0, 'base_qty': 2},
      ],
      'totals': {},
    },
