...
class _ExpenseVoucherEntryScreenState extends ConsumerState<ExpenseVoucherEntryScreen>
    with ScreenPermissionMixin<ExpenseVoucherEntryScreen>, ScreenHeaderMixin<ExpenseVoucherEntryScreen>, DeferredRowDisposal<ExpenseVoucherEntryScreen> {
  @override
  ...
  ScreenHeaderInfo buildScreenHeader() {
    ...
    final showReverseNow = _locked && canApprove && _postedVoucherNo != null;
    final showCopyNow = !_locked && !_isNew;
    return ScreenHeaderInfo(
      title: _transNo ?? 'New Expense Voucher',
      badgeText: _locked ? 'Posted' : 'Draft',
      badgeColor: _locked ? AppColors.positive : AppColors.secondary,
