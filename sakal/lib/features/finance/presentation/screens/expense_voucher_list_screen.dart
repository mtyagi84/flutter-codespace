...
class _ExpenseVoucherListScreenState extends ConsumerState<ExpenseVoucherListScreen>
    with ScreenPermissionMixin<ExpenseVoucherListScreen>, ScreenHeaderMixin<ExpenseVoucherListScreen> {
  @override
        ...
        actions: canAdd
            ? [
                Padding(
                  ...
                  child: FilledButton.icon(icon: const Icon(Icons.add, size: 16), label: const Text('New Expense Voucher'), onPressed: _openNew),
                ),
              ]
            : const [],
      );
  ...
  Widget build(BuildContext context) {
    ...
    // Title + New Expense Voucher button live in the shared TopBar via
