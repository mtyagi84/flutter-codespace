...
class _MaterialIssueListScreenState extends ConsumerState<MaterialIssueListScreen>
    with ScreenPermissionMixin<MaterialIssueListScreen>, ScreenHeaderMixin<MaterialIssueListScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    // Title + New Material Issue button live in the shared TopBar via
