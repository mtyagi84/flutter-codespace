...
class _MaterialRequisitionEntryScreenState extends ConsumerState<MaterialRequisitionEntryScreen>
    ...
    return ScreenHeaderInfo(
      ...
      actions: showDesktopActions
          ? [
              ...
              if (_requisitionNo != null) SakalHeaderActionButton(label: 'Print', icon: Icons.print_outlined, kind: SakalActionKind.neutral, loading: _printing, onPressed: _printing ? null : _printRequisition),
            ]
          : (_requisitionNo != null ? [_buildPrintButton()] : const []),
    );
  }
  ...
  Widget _buildHeaderCard(bool locked, bool isMobile) {
    ...
    final dateLocked = locked || _requisitionNo != null;
    ...
    final requisitionDateField = SakalFieldCard(
      ...
      child: InkWell(
        onTap: dateLocked ? null : () => _pickDate(_requisitionDate, (d) => setState(() => _requisitionDate = d)),
        child: Row(children: [
    ...
    return Container(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          const SizedBox(width: 8),
          SizedBox(width: 180, child: departmentField),
          const SizedBox(width: 8),
          SizedBox(width: 180, child: consumptionAreaField),
          const SizedBox(width: 8),
