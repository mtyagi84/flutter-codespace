...
class _MaterialRequisitionListScreenState extends ConsumerState<MaterialRequisitionListScreen>
    with ScreenPermissionMixin<MaterialRequisitionListScreen>, ScreenHeaderMixin<MaterialRequisitionListScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final searchField = SakalFieldCard(
      ...
      child: TextField(
        ...
        decoration: SakalFieldCard.bareDecoration.copyWith(
          hintText: 'Requisition no / requested by / reason…',
    ...
    // Title + New Requisition button live in the shared TopBar via
