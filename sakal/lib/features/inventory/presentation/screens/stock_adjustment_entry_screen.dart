...
class _StockAdjustmentEntryScreenState extends ConsumerState<StockAdjustmentEntryScreen>
    with ScreenPermissionMixin<StockAdjustmentEntryScreen>, ScreenHeaderMixin<StockAdjustmentEntryScreen> {
  ...
  ScreenHeaderInfo buildScreenHeader() {
    ...
    return ScreenHeaderInfo(
      title: _adjustmentNo != null ? 'Stock Adjustment · $_adjustmentNo' : 'New Stock Adjustment',
      subtitle: locked ? null : (_adjustmentNo != null ? 'Draft' : 'Unsaved draft'),
      badgeText: locked ? _status : null,
      badgeColor: locked ? AppColors.positive : null,
      trailingBadge: _adjustmentNo != null ? PendingSyncBadge(documentType: 'STOCK_ADJUSTMENT', documentId: _adjustmentNo!) : null,
      actions: showDesktopActions
          ? [
              ...
              if (canApproveNow) SakalHeaderActionButton(label: 'Approve', icon: Icons.check_circle_outline, kind: SakalActionKind.approve, loading: _approving, onPressed: _approving ? null : _approveAdjustment),
              if (_adjustmentNo != null) SakalHeaderActionButton(label: 'Print', icon: Icons.print_outlined, kind: SakalActionKind.neutral, loading: _printing, onPressed: _printing ? null : _printAdjustment),
            ]
          : (_adjustmentNo != null ? [_buildPrintButton()] : const []),
    );
  }
