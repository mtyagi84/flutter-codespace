            ...
            SizedBox(
              ...
              child: TextField(
                ...
                decoration: InputDecoration(
                  hintText: 'Search adjustment no…', hintStyle: const TextStyle(fontSize: 12),
                          ...
                          : Padding(
                              ...
                              child: Column(children: [
                                Container(
                                  ...
                                  child: Row(children: [
                                    _th('Adjustment No', flex: 2), _th('Date', flex: 2), _th('Location', flex: 3), _th('Reason', flex: 2), _th('Status', flex: 2), _th('', flex: 1),
                                  ]),
                                ),
                                Expanded(
