...
class _StockAdjustmentListScreenState extends ConsumerState<StockAdjustmentListScreen>
    with ScreenPermissionMixin<StockAdjustmentListScreen>, ScreenHeaderMixin<StockAdjustmentListScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    // Title + New Stock Adjustment button live in the shared TopBar via
