...
class _StockTransferRequestEntryScreenState extends ConsumerState<StockTransferRequestEntryScreen>
    with ScreenPermissionMixin<StockTransferRequestEntryScreen>, ScreenHeaderMixin<StockTransferRequestEntryScreen> {
  ...
  Future<void> _onBarcodeSubmitted(_RequestLineRow row, String rawBarcode) async {
    ...
    try {
      ...
      AppLogger.error('StockTransferRequestBarcodeLookup', e, st);
  ...
  Widget _buildHeaderCard(bool locked, bool isMobile) {
    ...
    final dateLocked = locked || _requestNo != null;
    ...
    final requestDateField = SakalFieldCard(
      ...
      child: InkWell(
        onTap: dateLocked ? null : () => _pickDate(_requestDate, (d) => setState(() => _requestDate = d)),
        child: Row(children: [
