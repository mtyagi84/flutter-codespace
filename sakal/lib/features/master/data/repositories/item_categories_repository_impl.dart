...
class ItemCategoriesRepositoryImpl implements ItemCategoriesRepository {
  ...
  @override Future<List<CategoryLevelModel>> getLevels({required String clientId, required String companyId}) =>
  ...
  @override Future<List<ProductFlagTypeModel>> getFlagTypes({required String clientId, required String companyId}) =>
  ...
  @override Future<List<ItemCategoryModel>> getCategories({required String clientId, required String companyId}) =>
