...
class _GrnListScreenState extends ConsumerState<GrnListScreen>
    with ScreenPermissionMixin<GrnListScreen>, ScreenHeaderMixin<GrnListScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    // Title + New Goods Receipt button live in the shared TopBar via
    ...
    return Column(
      ...
      children: [
        ...
        Expanded(
          child: SakalAdaptiveList<GrnModel>(
            loading: _loading,
            error: _error,
            rows: rows,
            columns: const [
              SakalListColumn('GRN No', flex: 2),
              SakalListColumn('Date', flex: 2),
              SakalListColumn('Mode', flex: 1),
