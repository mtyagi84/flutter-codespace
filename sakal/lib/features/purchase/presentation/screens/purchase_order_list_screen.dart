...
class _PurchaseOrderListScreenState extends ConsumerState<PurchaseOrderListScreen>
    with ScreenPermissionMixin<PurchaseOrderListScreen>, ScreenHeaderMixin<PurchaseOrderListScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    // Title + New Purchase Order button live in the shared TopBar via
