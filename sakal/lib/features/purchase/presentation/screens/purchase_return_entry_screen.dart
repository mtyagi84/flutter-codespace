...
class _PurchaseReturnEntryScreenState extends ConsumerState<PurchaseReturnEntryScreen>
    with ScreenPermissionMixin<PurchaseReturnEntryScreen>, ScreenHeaderMixin<PurchaseReturnEntryScreen> {
  ...
  Future<bool> _saveDraft() async {
    ...
    for (final c in _charges) {
      if (c.amount < 0) { _showSnack('${c.chargeName}: amount cannot be negative.', color: AppColors.negative); return false; }
    }
