        ...
        Padding(
          ...
          child: Wrap(spacing: 8, runSpacing: 8, crossAxisAlignment: WrapCrossAlignment.center, children: [
            DropdownButton<String?>(
              value: _filterMode,
              hint: const Text('All Modes', style: TextStyle(fontSize: 13)),
              isDense: true,
              underline: const SizedBox.shrink(),
              items: const [
                DropdownMenuItem(value: null, child: Text('All Modes', style: TextStyle(fontSize: 13))),
                DropdownMenuItem(value: 'DIRECT', child: Text('Direct', style: TextStyle(fontSize: 13))),
                DropdownMenuItem(value: 'AGAINST_QUOTATION', child: Text('Against Quotation', style: TextStyle(fontSize: 13))),
              ],
            ...
            SizedBox(
              ...
              child: TextField(
                ...
                decoration: InputDecoration(
                  hintText: 'Search order no / customer / PO ref…',
