...
/// whose subtitle string 'Pending X.XX Unit' is never rendered on the
/// desktop row — there it's shown only as a separate, unlabelled-together
/// field) would otherwise never render; some tests were written against
/// that mobile-card shape.
